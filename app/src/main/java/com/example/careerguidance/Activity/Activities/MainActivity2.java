...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question1.setText(questions.get(5).trim());
        question2 = (TextView) findViewById(R.id.q2);
        question2.setText(questions.get(6).trim());
        question3 = (TextView) findViewById(R.id.q3);
        question3.setText(questions.get(7).trim());
        question4 = (TextView) findViewById(R.id.q4);
        question4.setText(questions.get(8).trim());
        question5 = (TextView) findViewById(R.id.q5);
        question5.setText(questions.get(9).trim());
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent = new Intent(MainActivity2.this, IntroActivity.class);
