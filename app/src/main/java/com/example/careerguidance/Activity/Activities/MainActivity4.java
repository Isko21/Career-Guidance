...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question1.setText(questions.get(15).trim());
        question2 = (TextView) findViewById(R.id.q2);
        question2.setText(questions.get(16).trim());
        question3 = (TextView) findViewById(R.id.q3);
        question3.setText(questions.get(17).trim());
        question4 = (TextView) findViewById(R.id.q4);
        question4.setText(questions.get(18).trim());
        question5 = (TextView) findViewById(R.id.q5);
        question5.setText(questions.get(19).trim());
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent = new Intent(MainActivity4.this, IntroActivity.class);
